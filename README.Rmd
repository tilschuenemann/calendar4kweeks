...
This program creates a calendar; mapping each year and week of an 80 year lifespan and filling in the passed time.
...
You could use this picture for printing or generate one yourself. For more details take a loot at [ggsave](https://ggplot2.tidyverse.org/reference/ggsave.html).
